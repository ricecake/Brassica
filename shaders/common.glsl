...
TectonicPlate(normalize(vec3(0.781702, -0.313827, -0.675574)), -8.790901, 288.563980),
TectonicPlate(normalize(vec3(-0.544940, -0.578625, -0.817831)), -5.541290, 124.067426),
TectonicPlate(normalize(vec3(0.764724, -0.758624, 0.220931)), 2.806527, 84.178537),
TectonicPlate(normalize(vec3(-0.845838, 0.701362, 0.379266)), -8.153053, 228.901078),
TectonicPlate(normalize(vec3(-0.381264, 0.381033, -0.303168)), 4.863251, 377.196640),
TectonicPlate(normalize(vec3(-0.084245, -0.123529, -0.428414)), 8.443747, 27.949145),
TectonicPlate(normalize(vec3(-0.008251, -0.020373, 0.668197)), -5.812932, 248.354300),
TectonicPlate(normalize(vec3(-0.256714, -0.081912, -0.716820)), 6.273485, 140.094497),
TectonicPlate(normalize(vec3(-0.460961, 0.965205, 0.088123)), 0.295877, 1.715569),
TectonicPlate(normalize(vec3(-0.865460, 0.641724, -0.352464)), -0.352424, 160.361793),
TectonicPlate(normalize(vec3(0.070400, 0.387793, 0.368168)), 8.868693, 412.262066),
TectonicPlate(normalize(vec3(0.984231, 0.573760, 0.934164)), -8.558090, 412.602486),
TectonicPlate(normalize(vec3(0.079876, -0.653445, -0.065858)), -9.736542, 417.359132),
TectonicPlate(normalize(vec3(0.672340, 0.588920, 0.577776)), 2.192416, 383.884258),
TectonicPlate(normalize(vec3(0.333774, 0.686064, -0.224536)), 9.562980, 467.492884),
TectonicPlate(normalize(vec3(0.245426, 0.163644, 0.387474)), -4.338610, 498.968742),
TectonicPlate(normalize(vec3(0.568632, 0.106927, 0.494617)), 1.139006, 126.998885),
TectonicPlate(normalize(vec3(-0.823511, -0.992160, -0.911394)), 4.099460, 206.508712),
TectonicPlate(normalize(vec3(-0.726151, 0.740061, 0.728528)), 5.345101, 142.022913),
TectonicPlate(normalize(vec3(0.781628, -0.024227, 0.479503)), -7.927735, 190.691941),
TectonicPlate(normalize(vec3(-0.830069, 0.665175, 0.272761)), -9.915406, 148.581200),
TectonicPlate(normalize(vec3(-0.301866, 0.076971, 0.532133)), -8.074445, 169.180638),
TectonicPlate(normalize(vec3(-0.553763, -0.641426, 0.808767)), 3.367733, 254.801698),
TectonicPlate(normalize(vec3(0.550375, 0.388692, 0.833261)), -0.329726, 266.572225),
TectonicPlate(normalize(vec3(0.416787, -0.759494, -0.165650)), 7.536317, 415.420828),
TectonicPlate(normalize(vec3(0.963222, -0.026638, -0.067801)), 7.774334, 309.352842),
TectonicPlate(normalize(vec3(-0.394666, 0.587921, -0.341106)), 2.658085, 401.993628),
TectonicPlate(normalize(vec3(-0.134313, -0.470402, -0.689411)), -6.885421, 454.689700),
TectonicPlate(normalize(vec3(0.559338, 0.320648, 0.916626)), 0.046361, 258.120856),
TectonicPlate(normalize(vec3(0.997836, -0.442684, 0.062779)), 5.390185, 58.217201),
TectonicPlate(normalize(vec3(0.852824, 0.698527, 0.816947)), 7.256018, 320.095733),
TectonicPlate(normalize(vec3(0.141029, 0.371803, 0.535214)), 4.915803, 258.424871)
);
