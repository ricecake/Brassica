...
vec2 sampleToroidalUV(vec2 worldXZ, uint level, uint textureDim, uvec4 lodOffsets0_3, uvec4 lodOffsets4_7, uvec4 lodOffsets8_11) {
...
vec4 sampleTerrainClipmap(uint clipmapIndex, vec2 worldXZ, uint level, uint textureDim, uvec4 lodOffsets0_3, uvec4 lodOffsets4_7, uvec4 lodOffsets8_11) {
...
vec2 sampleTerrainMinMax(uint minMaxIndex, vec2 worldXZ, uint level, uint textureDim, uvec4 lodOffsets0_3, uvec4 lodOffsets4_7, uvec4 lodOffsets8_11) {
	vec2 uv = sampleToroidalUV(worldXZ, level, textureDim, lodOffsets0_3, lodOffsets4_7, lodOffsets8_11);
...
vec4 sampleTerrainBiome(uint biomeIndex, vec2 worldXZ, uint level, uint textureDim, uvec4 lodOffsets0_3, uvec4 lodOffsets4_7, uvec4 lodOffsets8_11) {
	vec2 uv = sampleToroidalUV(worldXZ, level, textureDim, lodOffsets0_3, lodOffsets4_7, lodOffsets8_11);
...
float sampleTerrainTileVisibility(uint visIndex, vec2 worldXZ, uint level, uint textureDim, uvec4 lodOffsets0_3, uvec4 lodOffsets4_7, uvec4 lodOffsets8_11) {
	vec2 uv = sampleToroidalUV(worldXZ, level, textureDim, lodOffsets0_3, lodOffsets4_7, lodOffsets8_11);
