...
graph-test:
	...
	@$(CXX) $(GRAPH_CXXFLAGS) -o $(BUILD_DIR)/bin/test_graph tests/graph/test_graph.cpp src/lighting/LightManager.cpp src/lighting/LightningManager.cpp src/ArgparseManager.cpp src/ConfigManager.cpp
