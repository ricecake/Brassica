...
namespace brassica {
	...
	struct ArgparseManagerState {
		...
		auto GetReflection() const {
			return std::make_tuple(
				...
				MakeField("maxFrames", "Max Frames (0 = unlimited)", &ArgparseManagerState::maxFrames, 0u, 100000u, UIHint::Slider),
	...
	public:
		...
		State GetState() const override {
			return State{GetHeadless(), GetMaxFrames(), GetConfigFile(), GetAppName()};
		}
