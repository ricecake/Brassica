	...
	struct TerrainAccelerationStructureState {
		...
		auto GetReflection() const {
			return std::make_tuple(
				MakeField("enabled", "Enable Terrain Acceleration Structure", &TerrainAccelerationStructureState::enabled)
			);
		}
	};

	class TerrainAccelerationStructure: public ManagerBase<TerrainAccelerationStructure, TerrainAccelerationStructureState> {
	public:
